...
CLRSCR MACRO
    MOV AH, 6   	  	;функция 6. Очистить весь экран.
    XOR AL, AL
    XOR CX, CX
...
RANDOMIZE:				;SELECTS RANDOM POSITION AND VALUE
	...
	;shr - сдвиговая команда, получает на вход регистр для сдвига и количество сдвигов
	SHR AH, 1 			;если остаток будет нечетным появится 2, если четным то 4
	JC FOUR
...
GRID:					;PRINTS THE GRID
	MOV TMP1, 5			;5 вертикальных линий, 5 горизонтальных
	MOV CSR, 0
GROW:
	SUB TMP1, 1
	SETCURSOR CSR, 0
...
CONT2:
    ...
    CMP TMP1, 'K'			;проверка выйгрышной ситуации
    JE WIN

    MOV AH, FLAG			;проверка проигрышной ситуации
    CMP AH, 1
    JNE LOSE
